...
public class EnergyAwareRouter extends ActiveRouter
    ...
    private final double scanInterval;
    ...
    public void setLastUpdateTime(double time) {
    ...
    public double getScanEnergy() {
        return this.scanEnergy;
    }

    public double getTransmitEnergy() {
        return this.transmitEnergy;
    }

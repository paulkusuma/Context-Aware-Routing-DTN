...
import routing.testContext.bufferCalculator;
 ...
 *
 */
public class SprayAndWaitRouterBufferTest extends ActiveRouter {
    ...
    public SprayAndWaitRouterBufferTest(Settings s) {
        super(s);
     ...
     */
    protected SprayAndWaitRouterBufferTest(SprayAndWaitRouterBufferTest r) {
        super(r);
    ...
    public void update() {
        ...
        /* Ambil daftar host yang terhubung (tetangga) */
        List<DTNHost> neighbors = getNeighbors(this.getHost());

        /* Panggil bufferCalculator dengan daftar tetangga */
    ...
    /**
     * Mengambil daftar node tetangga yang terhubung melalui koneksi.
     */
    ...
    @Override
    public SprayAndWaitRouterBufferTest replicate() {
        return new SprayAndWaitRouterBufferTest(this);
    }
}
